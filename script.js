...
$('.button').hover(function(){
    if($(".effect").hasClass("start")){
        ...
        $('.dolars').css('right','31%');
        $('.dolars').css('bottom','16%');
        $('.dolars').css('transform','rotateY(192deg) rotate(-97deg)');
}
,function(){
       beginPosition();
});
...
function beginPosition(){
    $('.dolars').css('right','50%');
    $('.dolars').css('bottom','25%');
    $('.dolars').css('transform','rotateY(192deg) rotate(-40deg)');
}
...
$('.item').hover(function(event){
    ...
    $('.dolars').css('right',leftNew +'%');
    $('.dolars').css('bottom', topNew +'%');
